    ...
    return (
        <div className="min-h-screen">
            ...
            <section className="relative py-24 overflow-hidden">
                ...
                <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-1.5 mb-8">
                        ...
                        <span className="text-sm text-gray-300">About MakeMyPortal</span>
                    </div>
                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative bg-white/[0.03] border border-white/10 rounded-2xl p-8 hover:border-white/20 transition-all duration-300 h-full">
            ...
            <section className="py-20">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl sm:text-4xl font-heading font-bold text-white mb-4">Meet Our Founders</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        {founders.map((founder, i) => (
                            <div key={i} className="relative group">
                                ...
                                <div className="relative bg-white/[0.03] border border-white/10 rounded-2xl p-8 hover:border-white/20 transition-all duration-300 text-center">
                                    <div className={`w-24 h-24 rounded-full bg-gradient-to-br ${founder.gradient} flex items-center justify-center mx-auto mb-6 shadow-lg shadow-brand-primary/20`}>
                                        <span className="text-3xl font-heading font-bold text-white">{founder.initial}</span>
                                    </div>
                                    <h3 className="text-xl font-heading font-bold text-white mb-1">{founder.name}</h3>
            ...
            <section className="py-20">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl sm:text-4xl font-heading font-bold text-white mb-4">What We Stand For</h2>
                        <p className="text-gray-400 max-w-2xl mx-auto">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-white/[0.03] border border-white/10 rounded-3xl p-12">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                ...
                                <Link to="/services" className="inline-flex items-center justify-center gap-2 bg-white/5 border border-white/10 text-white font-semibold px-8 py-3.5 rounded-xl hover:bg-white/10 transition-all duration-300">
                                    View Services
                                </Link>
                            </div>
                        </div>
