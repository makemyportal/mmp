                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {contactInfo.map((info, i) => (
                            <div key={i} className="relative group">
                                <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6 hover:border-white/20 transition-all duration-300 h-full">
                                    ...
                                    {info.link ? (
                                        <a href={info.link} className="text-white text-sm font-medium hover:text-brand-primary transition-colors break-all">{info.value}</a>
                                    ) : (
                        ...
                        <div className="relative bg-white/[0.03] border border-green-500/20 rounded-2xl p-8 sm:p-10">
                            <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-8">
                                ...
                                <div className="text-center sm:text-left flex-grow">
                                    <h2 className="text-2xl font-heading font-bold text-white mb-2">Book via WhatsApp</h2>
                                    <p className="text-gray-400 text-sm mb-5">Instant booking! Message us on WhatsApp and get a quick response.</p>
                                    <div className="flex flex-col sm:flex-row gap-3">
                                        <a
                                            href="https://wa.me/918077162909?text=Hi%20MakeMyPortal!%20I%20want%20to%20book%20a%20service."
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 shadow-lg shadow-green-600/20 hover:shadow-green-600/40"
                                        >
            ...
            <section className="pb-24">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="relative">
                        ...
                        <div className="relative bg-dark-800/80 backdrop-blur-sm border border-white/10 rounded-2xl p-8 sm:p-10">
                            <div className="flex items-center gap-3 mb-8">
                                ...
                                <div>
                                    <h2 className="text-xl font-heading font-bold text-white">Send us a Message</h2>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm placeholder-gray-500 focus:outline-none focus:border-brand-primary/50 focus:ring-1 focus:ring-brand-primary/30 transition-all"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white text-sm placeholder-gray-500 focus:outline-none focus:border-brand-primary/50 focus:ring-1 focus:ring-brand-primary/30 transition-all resize-none"
