        ...
        <div className="py-12 relative w-full overflow-hidden">
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 mb-6 flex justify-between items-end">
                ...
                <div className="flex gap-2 hidden sm:flex">
                    <button onClick={scrollLeft} className="w-10 h-10 rounded-full glass-panel flex items-center justify-center hover:bg-white/10 transition-colors border-white/20">
                        <ArrowLeft className="w-5 h-5 text-white" />
                    </button>
                    <button onClick={scrollRight} className="w-10 h-10 rounded-full glass-panel flex items-center justify-center hover:bg-white/10 transition-colors border-white/20">
                ...
                {items.map((item, index) => (
                    ...
                    >
                        <motion.div
                            ...
                            className={`relative glass-panel rounded-2xl overflow-hidden group border border-white/10 hover:border-brand-primary/50 transition-colors
              ...
              `}
                        >
                            ...
                            <div className={`w-full overflow-hidden relative ${isTemplate ? 'h-48' : 'h-56'}`}>
                                ...
                                />
                                <div className="absolute top-4 right-4 z-20 glass-panel px-3 py-1.5 rounded-full text-xs font-bold text-white shadow-lg border-white/20 backdrop-blur-xl bg-black/40">
                                    {item.price}
                                </div>
                            </div>
                            ...
                            <div className="p-6 relative z-20 flex flex-col h-[calc(100%-12rem)] md:h-[calc(100%-14rem)]">
                                <h3 className="text-xl font-bold text-white font-heading mb-2 line-clamp-1 group-hover:text-brand-primary transition-colors">
                                    {item.title}
                                </h3>
                                ...
                                <div className="mt-auto">
                                    <button
                                        ...
                                        className="w-full flex justify-center items-center gap-2 py-2.5 px-4 rounded-xl font-semibold text-white bg-white/5 border border-white/10 hover:bg-white/10 hover:border-brand-primary/50 transition-all text-sm group/btn"
                                    >
